...
sliders : Test
sliders =
    describe "Slider setss the disired field in the Model"
        [ testSlider "SlideHue" SlidHue .hue
        , testSlider "SlideRipple" SlidRipple .ripple
        , testSlider "SlideNoise" SlidNoise .noise
        ]
...
thumbnailWorks : Test
thumbnailWorks =
    fuzz urlFuzzer "URL's render as thumbnails" <|
        \urls ->
            let
